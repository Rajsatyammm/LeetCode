class Solution {
    ...
    public int numOfWays(int[] nums) {
        ...
        return (int)((getNumber(list)-1)%mod);
    }
    
    public long getNumber(List<Integer> nums){
        ...
        return ((((comb(lessThan.size() + greaterThan.size(), greaterThan.size()))%mod) * getNumber(lessThan))%mod * getNumber(greaterThan))%mod;
    }
